...
// Update selected element's text alignment
...
// Get the select input and color options container
const backgroundSelect = document.getElementById('backgroundSelect');
const colorOptions = document.getElementById('colorOptions');

// Add event listener to handle background style selection
backgroundSelect.addEventListener('change', function(event) {
    const selectedOption = event.target.value;
    if (selectedOption === 'color') {
        colorOptions.style.display = 'block'; // Show color options when "Flat Color" is selected
    } else {
        colorOptions.style.display = 'none'; // Hide color options for other selections
        if (selectedElement) {
            selectedElement.style.backgroundColor = 'transparent'; // Reset background color to transparent
        }
    }
});

// Update selected element's background color when color picker value changes
...
function openContentInNewTab() {
    ...
    newWindow.document.write('<title>Preview</title>');
    newWindow.document.write('<link rel="stylesheet" type="text/css" href="styles_preview.css">');
    newWindow.document.write('</head>');
    newWindow.document.write('<body>');
    newWindow.document.write(contentHTML);
    newWindow.document.write('<script src="script_preview.js"></script>');
    newWindow.document.write('</body>');
